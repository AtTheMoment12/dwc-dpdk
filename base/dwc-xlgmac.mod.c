...
__attribute__((section("__versions"))) = {
	...
	{ 0x55b5a16f, "pci_sriov_get_totalvfs" },
	{ 0x37a0cba, "kfree" },
	{ 0x69acdf38, "memcpy" },
	{ 0x84f7f09d, "skb_add_rx_frag" },
	{ 0x64edc7e0, "pci_num_vf" },
...
MODULE_INFO(srcversion, "C87A20130D4F863453B8C65");
